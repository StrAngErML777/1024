...
import com.example.mlsq004.bean.UserInfo;
import com.example.mlsq004.database.UserDBHelper;
import com.example.mlsq004.util.DateUtil;
import com.example.mlsq004.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"莫骆帅奇18990040","个人用户", "公司用户"};
